...
export default function ProjectDialoge(props: ProjectDialogeProps) {
  ...
  useEffect(() => {
    if (props.project?.npm && props.project?.npm !== npmName && downloads === -1) {
      getDownloads(props.project?.npm).then(() => console.log("Retrieved downloads"));
    }
  }, []);
  ...
  const contentStyle: React.CSSProperties = {
    backgroundImage: `url('https://raw.githubusercontent.com/karafra/karafra.dev/master/src/assets/images/${props.project?.image}.png')`,
  };
